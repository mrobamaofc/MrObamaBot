		...
		try {
			...
			mess = {
				...
				only: {
					...
					ownerB: '❌ Este comando só pode ser usado pelo Obama 🤠',
					admin: '⚠️ Este comando só pode ser usado por admins chora não membros comum 😝',
			...
			switch(command) {
				...
				case 'dono':
					memein = await kagApi.memeindo()
					buffer = await getBuffer(`https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT5I11MfhWxUPKAsILePS57DrlYXD9Xl3RsvQ&usqp=CAU`)
					client.sendMessage(from, buffer, image, {quoted: mek, caption: '*CRIADOR:* Obama\n*YOUTUBE:* https://youtube.com/channel/UCA9AAcud67cklytRTStfApw\n*WPP:* wa.me/+553899815548\n*INSTA:* https://www.instagram.com/p/CJueBx1htip/?igshid=1dp7a6tdbsvg7'})
					break
				case 'belle2':
					memein = await kagApi.memeindo()
				...
				case 'canal':
					memein = await kagApi.memeindo()
					buffer = await getBuffer(`https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT5I11MfhWxUPKAsILePS57DrlYXD9Xl3RsvQ&usqp=CAU`)
					client.sendMessage(from, buffer, image, {quoted: mek, caption: '️*canal do obama:*\n\n https://youtube.com/channel/UCA9AAcud67cklytRTStfApw'})
					break
				case 'mia1':
					memein = await kagApi.memeindo()
